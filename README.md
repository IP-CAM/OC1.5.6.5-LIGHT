...
# The fastest freeware OC, in the North, South, East+West
   ...
   Security- and Codewise refined and updated to match MySQLi (i.E.utf8mb4) and PHP v.7.4.20
...
# Links:
   ...
   system/library/encryption.php file, to make latest Version PHP v.7.4.20 work.
   ---
   ...
   this 'official' OpenCart Github Download does not yet contain the latest PHP v.7.4.20 capable encryption file.
