  ...
  <div class="container">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <a href="xturbo.php?action=indexes" class="btn btn-success btn-lg" onclick="return confirm('Are you sure you want to add Indexes to your Opencart database tables?');">Add Database Indexes</a>
      </div>
    </div>
