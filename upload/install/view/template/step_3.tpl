...
<div id="content">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <p><strong>1. Please enter your database connection details.</strong></p>
    <fieldset>
      <table class="form">
        <tr>
    ...
    <p><strong>2. Please enter your Admin Username and Password for the Shop-Administration.</strong></p>
    <fieldset>
      <table class="form">
        <tr>
          <td><span class="required">*</span> OpenShop Admin Username:</td>
        ...
        <tr>
          <td><span class="required">*</span> OpenShop Admin Password:</td>
        ...
        <tr>
          <td><span class="required">*</span> OpenShop Admin E-Mail:</td>
