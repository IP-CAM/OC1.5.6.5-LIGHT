...
$_['text_scale_image']		= 'Scale image (input scale image size first)';
$_['text_crop_image']		= 'Crop image (select area on the image)';
$_['text_rotate_counter']	= 'Rotate counter-clockwise';
$_['text_rotate_clockwise'] = 'Rotate clockwise';
$_['text_flip_vertically']	= 'Flip vertically';
$_['text_flip_horizontally']= 'Flip horizontally';
$_['text_undo']				= 'Undo';
$_['text_redo']				= 'Redo';
$_['text_scale_description']= 'You can proportionally scale the original image. For best results the scaling should be done before performing any other operations on it like crop, rotate, etc. Note that if you make the image larger it may become fuzzy.';
...
$_['error_degree']     = 'Warning: Please set correct degree!';
