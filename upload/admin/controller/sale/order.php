...
// JTI MOD Error editing order - https://for-opencart.com/utility/error-undefined-in-edit-order
		//	$this->data['store_url'] = $order_info['store_url'];
			$this->data['store_url'] = substr($order_info['store_url'], 1 + strpos($order_info['store_url'], ":"));
// END JTI MOD
