...
<div id="content">
  ...
  <div class="box">
	...
	<a onclick="$('#form-insert').submit();" class="reds-btn2"><span><?php echo $button_save; ?></span></a>
	<a onclick="fnCancel();" class="reds-btn2"><span><?php echo $button_cancel; ?></span></a>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr class="tr<?php echo $url_alias['url_alias_id']; ?>">
              ...
              <td class="center"><a class="reds-btn2" onclick="itemEdit(<?php echo $url_alias['url_alias_id']; ?>)"><?php echo $url_alias['action_text']; ?></a></td>
            </tr>
            <?php } ?>
            <?php } else { ?>
            <tr>
