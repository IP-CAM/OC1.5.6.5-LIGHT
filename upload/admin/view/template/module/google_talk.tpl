        ...
        <table id="module" class="list">
          <thead>
            <tr>
              ...
              <td class="v"><?php echo $entry_sort_order; ?></td>
              <td></td>
            </tr>
          </thead>
          <?php $module_row = 0; ?>
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="center"><select name="google_talk_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="center"><select name="google_talk_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="center"><input type="text" name="google_talk_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
