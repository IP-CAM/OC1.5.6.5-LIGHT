        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="center"><select name="pp_layout_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="center"><select name="pp_layout_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="center"><input type="text" name="pp_layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
	...
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="center"><select name="pp_layout_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="center"><select name="pp_layout_module[' + module_row + '][status]">';
