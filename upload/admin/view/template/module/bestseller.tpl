          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="bestseller_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" />
                ...
                <?php } ?></td>
              <td class="center"><select name="bestseller_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="center"><select name="bestseller_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="center"><select name="bestseller_module[<?php echo $module_row; ?>][status]">
