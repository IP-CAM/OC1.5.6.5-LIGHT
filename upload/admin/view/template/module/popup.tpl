...
Extension Name : PopUp Jquery Module
Date : 27-Jan-15
License : Free
Contact : penthemes@gmail.com
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
			  <tr>
                ...
                <td><input size="60" name="popup_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" id="module_title-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>"/></td>
              </tr>
			  
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="popup_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          <table class="form">
			...
			<tr>
              <td><?php echo $entry_module_class; ?></td>
               <td><input type="text" name="popup_module[<?php echo $module_row; ?>][module_class]" value="<?php echo isset($module['module_class'])?$module['module_class']:""; ?>" size="10" /></td>
            </tr>
...
function addModule() {	
	...
	html += '          <td><input name="popup_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" id="module_title-' + module_row + '-<?php echo $language['language_id']; ?>"/></td>';
	html += '        </tr>';
	html += '        <tr>';
	html += '          <td><?php echo $entry_description; ?></td>';
	html += '          <td><textarea name="popup_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '    <td class="left"><select name="popup_module[' + module_row + '][position]">';
	 <?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><input type="text" name="popup_module[' + module_row + '][module_class]" value="" size="13" /></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_sort_order; ?></td>';
	html += '      <td><input type="text" name="popup_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
