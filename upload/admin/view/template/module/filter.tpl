        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="center"><select name="filter_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="center"><select name="filter_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="center"><input type="text" name="filter_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
