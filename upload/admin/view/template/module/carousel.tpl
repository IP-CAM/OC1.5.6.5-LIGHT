          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="carousel_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                ...
                <?php } ?></td>
              <td class="center"><select name="carousel_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="center"><select name="carousel_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="center"><select name="carousel_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="center"><input type="text" name="carousel_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
