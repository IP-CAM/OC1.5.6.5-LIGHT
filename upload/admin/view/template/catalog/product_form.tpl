...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
	  ...
	  <div style="clear:both; padding-top: 5px; border-top: 1px solid #EBEBEB;"></div>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="80" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="80" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a class="reds-btn2" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a class="reds-btn2" onclick="addAttribute();" class="reds-btn2"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="reds-btn2"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
        ...
        <div id="tab-profile">
            <table class="list">
                ...
                <tbody>
                    ...
                    <?php foreach ($product_profiles as $product_profile): ?>
                        ...
                        <tr id="profile-row<?php echo $profileCount ?>">
                            ...
                            <td class="left">
                                <a class="reds-btn2" onclick="$('#profile-row<?php echo $profileCount ?>').remove()"><?php echo $button_remove ?></a>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2"></td>
                        <td class="left"><a onclick="addProfile()" class="reds-btn2"><?php echo $button_add_profile ?></a></td>
                    </tr>
                </tfoot>
            </table>
        </div>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="reds-btn2"><?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="reds-btn2"><?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="reds-btn2"><?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addDiscount() {
	...
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	...
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
...
function addImage() {
	...
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addProfile() {
    ...
    html += '  </td>';
    html += '  <td class="left">';
    html += '    <a class="reds-btn2" onclick="$(\'#profile-row' + profileCount + '\').remove()"><?php echo $button_remove ?></a>';
    html += '  </td>';
    html += '</tr>';
