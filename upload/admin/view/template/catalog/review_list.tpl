       ...
       <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'r.author') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php if ($sort == 'r.rating') { ?>
              ...
              <td class="center"><?php if ($sort == 'r.status') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php if ($sort == 'r.date_added') { ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="center"><?php echo $review['rating']; ?></td>
              <td class="center"><?php echo $review['status']; ?></td>
              <td class="center"><?php echo $review['date_added']; ?></td>
              <td class="center"><?php foreach ($review['action'] as $action) { ?>
