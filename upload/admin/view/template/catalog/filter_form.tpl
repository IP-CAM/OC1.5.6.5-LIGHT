        ...
        <table id="filter" class="list">
          ...
          <tbody id="filter-row<?php echo $filter_row; ?>">
            <tr>
              ...
              <td class="center"><a onclick="$('#filter-row<?php echo $filter_row; ?>').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $filter_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="center"><a onclick="addFilter();" class="reds-btn2"><?php echo $button_add_filter; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addFilter() {
	...
	html += '     <td class="center"><a onclick="$(\'#filter-row' + filter_row + '\').remove();" class="reds-btn2"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
