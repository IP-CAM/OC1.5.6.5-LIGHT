      ...
      <form action="<?php echo $backup; ?>" method="post" enctype="multipart/form-data" id="backup">
        <table class="form">
          <tr>
            ...
            <td><div class="scrollbox big-box" style="margin-bottom: 5px;">
                <?php $class = 'odd'; ?>
              ...
              <a class="reds-btn" style="float: right; margin-right: 150px; margin-top: -250px;" onclick="$(this).parent().find(':checkbox').attr('checked', true);"><?php echo $text_select_all; ?></a>
			  <a class="reds-btn" style="float: right; margin-right: 250px; margin-top: -250px;" onclick="$(this).parent().find(':checkbox').attr('checked', false);"><?php echo $text_unselect_all; ?></a></td>
          </tr>
        </table>
      </form>
    </div>
