                ...
                <tbody>
                    <?php if ($attempts) { ?>
                        <?php foreach ($attempts as $attempt) { ?>
                            <tr>
                                <?php if (empty($filter_group) || $filter_group == 'none') { ?>
                                    <td class="left"><?php echo $attempt['timestamp']; ?></td>
                                <?php } else { ?>
                                    <td class="left"><?php echo $attempt['date_start']; ?></td>
                                    <td class="left"><?php echo $attempt['date_end']; ?></td>
                                <?php } ?>
                                <td class="left"><?php echo $attempt['username']; ?></td>
                                <td class="left"><?php echo $attempt['host']; ?></td>
                                <td class="right"><?php echo $attempt['attempts']; ?></td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
                        <tr>
...
<script type="text/javascript"><!--
    function filter() {
        var url = 'index.php?route=report/security/login_attempts&token=<?php echo $token; ?>';
