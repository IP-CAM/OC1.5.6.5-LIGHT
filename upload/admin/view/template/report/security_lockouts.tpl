                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td><?php echo $column_start_time; ?></td>
                            <td><?php echo $column_expire_time; ?></td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if ($hosts) { ?>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <?php if ($host['selected']) { ?>
                                            <input type="checkbox" name="selected[]" value="<?php echo $host['lockout_id']; ?>" checked="checked"/>
                                        <?php } else { ?>
                                            <input type="checkbox" name="selected[]" value="<?php echo $host['lockout_id']; ?>"/>
                                        <?php } ?>
                                    </td>
                                    <td class="left"><?php echo $host['host']; ?></td>
                                    <td><?php echo $host['start_time']; ?></td>
                                    <td><?php echo $host['expire_time']; ?></td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
                            <tr>
