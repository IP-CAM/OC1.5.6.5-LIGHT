        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'c.email') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php echo $column_balance; ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="center"><a onclick="filter();" class="reds-btn2"><?php echo $button_filter; ?></a></td>
            </tr>
            <?php if ($affiliates) { ?>
            ...
            <tr>
              ...
              <td class="center"><?php foreach ($affiliate['action'] as $action) { ?>
