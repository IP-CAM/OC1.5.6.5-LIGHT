...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><span id='review-title' style='margin-right: 10px; font-size: 16px; font-weight: bold; color: red'></span> <a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a><a onclick="resendMails('<?=$order_id?>'); return false;" class="button">Send eMail Order to Buyer</a></div>
    </div>
    <div class="content">
        ...
        <div id="tab-product" class="vtabs-content">
          ...
          <table class="list">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-product" class="reds-btn2"><?php echo $button_add_product; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-voucher" class="vtabs-content">
          ...
          <table class="list">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-voucher" class="reds-btn2"><?php echo $button_add_voucher; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-total" class="vtabs-content">
          ...
          <table class="list">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-update" class="reds-btn2"><?php echo $button_update_total; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
		...
		if (ui.item['option'] != '') {
			...
			for (i = 0; i < ui.item['option'].length; i++) {
				...
				if (option['type'] == 'file') {
					...
					html += option['name'] + '<br />';
					html += '<a id="button-option-' + option['product_option_id'] + '" class="reds-btn2"><?php echo $button_upload; ?></a>';
