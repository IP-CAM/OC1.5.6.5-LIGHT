        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><?php echo $total; ?>
              ...
              <?php if (!$credit_total) { ?>
              <span id="credit"><a class="button" id="credit-add"><?php echo $text_credit_add; ?></a></span>
              <?php } else { ?>
              <span id="credit"><a class="button" id="credit-remove"><?php echo $text_credit_remove; ?></a></span>
              <?php } ?>
              <?php } ?></td>
          </tr>
          ...
          <tr>
            ...
            <td><?php echo $reward; ?>
              <?php if (!$reward_total) { ?>
              <span id="reward"><a class="button" id="reward-add"><?php echo $text_reward_add; ?></a></span>
              <?php } else { ?>
              <span id="reward"><a class="button" id="reward-remove"><?php echo $text_reward_remove; ?></a></span>
              <?php } ?></td>
          </tr>
          <?php } ?>
          <?php if ($order_status) { ?>
