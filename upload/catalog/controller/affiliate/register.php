...
class ControllerAffiliateRegister extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$this->data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/info', 'information_id=' . $this->config->get('config_affiliate_id'), 'SSL'), $information_info['title']);
			} else {
