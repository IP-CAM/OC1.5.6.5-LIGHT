	...
	public function info() { 
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				$this->data['products'][] = array(
					'thumb'    => $thumb,
					'name'     => (utf8_strlen($product['name']) > 24 ? utf8_substr($product['name'], 0, 24) . '..' : $product['name']),
					'model'    => (utf8_strlen($product['model']) > 10 ? utf8_substr($product['model'], 0, 10) . '' : $product['model']),
					'option'   => $option_data,
