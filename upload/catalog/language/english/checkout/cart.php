...
// Text
$_['text_success']           = '<strong>Success:</strong> You have added <strong><a href="%s">%s</a></strong> to your <a class="btn-success" href="%s">&nbsp;Shopping Cart!&nbsp;</a>';
$_['text_remove']            = '<strong>Success:</strong> You have modified your shopping cart!';
$_['text_coupon']            = '<strong>Success:</strong> Your coupon discount has been applied!';
$_['text_voucher']           = '<strong>Success:</strong> Your gift voucher discount has been applied!';
$_['text_reward']            = '<strong>Success:</strong> Your reward points discount has been applied!';
$_['text_shipping']          = '<strong>Success:</strong> Your shipping estimate has been applied!';
