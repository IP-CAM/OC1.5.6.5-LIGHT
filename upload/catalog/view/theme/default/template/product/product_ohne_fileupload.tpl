	...
	<hr>			
			...
			<?php } ?>  
					...
					<div class="wishlist" style="text-align:center">
						<a onclick="addToWishList('<?php echo $product_id; ?>');"><i class="fa fa-thumb-tack fa-1x" ></i> <?php echo $button_wishlist; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a onclick="addToCompare('<?php echo $product_id; ?>');"><i class="fa fa-thumb-tack fa-1x"></i> <?php echo $button_compare; ?></a>
					</div>
				</div>
			</form>
