...
<?php if ($error_warning) { ?>
	<div class="alert alert-danger"><?php echo $error_warning; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close"></div>
<?php } ?>
...
<?php if ($has_shipping) { ?>
	<?php if (!isset($shipping_methods)) { ?>
		<div class="alert alert-danger"><?php echo $error_no_shipping ?></div>
	<?php } else { ?>
...
<?php } ?>
	...
	<div class="well">
		<div class="text-right"><a href="<?php echo $action_confirm; ?>" class="btn btn-default"><?php echo $button_confirm; ?></a></div>
	</div>
