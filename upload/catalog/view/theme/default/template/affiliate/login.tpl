...
<div class="row">
	...
	<div class="col-sm-<?php $span = trim($column_left) ? 9 : 12; $span = trim($column_right) ? $span - 3 : $span; echo $span; ?>">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="#"><?php echo $text_returning_affiliate; ?></a></li>
			<li><a href="<?php echo $register; ?>"><?php echo $text_new_affiliate; ?></a></li>
		</ul>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						<div class="panel-heading"><strong><?php echo $text_new_affiliate; ?></strong></div>
